# 1º passo: Informar a imagem base
FROM ubuntu:16.04
# Informações sobre o dono
LABEL maintainer="Catharina Mesquita"

#Atualizando o SO e intalando o openssh
...
RUN apt-get install -y build-essential automake autoconf \
    ...
    gawk g++ make libc6-dev patch libsqlite3-dev sqlite3 \
